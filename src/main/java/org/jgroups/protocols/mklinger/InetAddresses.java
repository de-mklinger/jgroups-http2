...
public class InetAddresses {
	...
	public static String toAddrString(final InetAddress ip) {
		...
		final byte[] bytes = ip.getAddress();
		final int[] hextets = new int[IPV6_PART_COUNT];
	...
	public static InetAddress of(final String hostOrIp) {
		final byte[] addr = ipStringToBytes(hostOrIp);
		if (addr != null) {
			return bytesToInetAddress(addr);
		}
		// Not an ip address, try getByName:
		try {
	 ...
	 */
	public static InetAddress ofIp(final String ipString) {
