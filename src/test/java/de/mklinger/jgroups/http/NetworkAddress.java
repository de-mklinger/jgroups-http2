...
public final class NetworkAddress {
	 ...
	 */
	public static String format(final InetSocketAddress address) {
	 ...
	 * @return formatted string
	 */
	public static String formatAddress(final InetAddress address) {
	 ...
	 * @return formatted string
	 */
	public static String formatAddress(final InetSocketAddress address) {
	...
	static String format(final InetAddress address, final int port, final boolean includeHost) {
		...
		if (includeHost) {
			...
			final int separator = toString.indexOf('/');
			if (separator > 0) {
